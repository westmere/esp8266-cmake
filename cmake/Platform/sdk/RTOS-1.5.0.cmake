...
set(ADDR 0x01000)
set(ESP_SYS_PARAM_ADDR 0x7C000)
set(ESP_RF_CAL_ADDR 0x7B000)
set(ESP_DEFAULT_ADDR 0x7E000)
if(${APP} STREQUAL 0)
    set(BOOT_MODE 0)
else()
    set(BOOT_MODE 2)
...
if(NOT ${BOOT_MODE} STREQUAL 0)
    ...
    elseif(${SPI_SIZE_MAP} STREQUAL 2)
        ...
        set(ESP_SYS_PARAM_ADDR 0xFC000)
        set(ESP_RF_CAL_ADDR 0xFB000)
        set(ESP_DEFAULT_ADDR 0xFE000)
    elseif(${SPI_SIZE_MAP} STREQUAL 3)
        ...
        set(ESP_SYS_PARAM_ADDR 0x1FC000)
        set(ESP_RF_CAL_ADDR 0x1FB000)
        set(ESP_DEFAULT_ADDR 0x1FE000)
    elseif(${SPI_SIZE_MAP} STREQUAL 4)
        ...
        set(ESP_SYS_PARAM_ADDR 0x3FC000)
        set(ESP_RF_CAL_ADDR 0x3FB000)
        set(ESP_DEFAULT_ADDR 0x3FE000)
    ...
    elseif(${SPI_SIZE_MAP} STREQUAL 8)
        ...
        set(ESP_SYS_PARAM_ADDR 0x7FC000)
        set(ESP_RF_CAL_ADDR 0x7FB000)
        set(ESP_DEFAULT_ADDR 0x7FE000)
    elseif(${SPI_SIZE_MAP} STREQUAL 9)
        ...
        set(ESP_SYS_PARAM_ADDR 0xFFC000)
        set(ESP_RF_CAL_ADDR 0xFFB000)
        set(ESP_DEFAULT_ADDR 0xFFE000)
    endif()
