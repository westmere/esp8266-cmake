...
if(NOT ${BOOT_MODE} STREQUAL 0)
    ...
    elseif(${SPI_SIZE_MAP} STREQUAL 2)
        ...
        set(LD_FILE "eagle.app.v6.new.1024.app${APP}.ld")
        set(flash 1024)
...
function(esp8266_add_firmware FIRMWARE TARGET)
    ...
    if(${APP} STREQUAL 0)
        ...
        add_custom_target(${FIRMWARE}
                        ...
                        VERBATIM
                        DEPENDS RTOS_SDK_FIRMWARE0
                        COMMAND ${CMAKE_COMMAND} -E copy ${ESP8266_SDK_BASE}/bin/${BOOT_NAME} ${CMAKE_BINARY_DIR}/firmware/${BOOT_NAME}
    ...
    file(COPY ${ESPTOOL} DESTINATION ${CMAKE_BINARY_DIR}/firmware)
